...
const WhyEagleLikes = () => {
    ...
    return (
        <section className="relative w-full py-12 sm:py-24 bg-black overflow-hidden border-b border-[#0663CD4D]">
            {/* Right Shadow */}
            ...
            <div className="relative z-10 max-w-269.5 mx-auto px-4 xl:px-0">
                ...
                <div className="hidden md:grid grid-cols-2 lg:grid-cols-3 gap-5">
                    {FEATURES.map((feature, idx) => (
                        <div
                            key={idx}
                            className="bg-[#FFFFFF0D] rounded-[40px] px-8 py-6 flex flex-col items-center text-center border border-[#FFFFFF26] transition-colors group h-full"
                        >
