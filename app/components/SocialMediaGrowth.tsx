                ...
                <div className="flex flex-col items-center lg:items-start text-center lg:text-left max-w-117">
                    ...
                    <div className="grid grid-cols-2 gap-4 w-full mb-8">
                        {STATS_DATA.map((stat, idx) => (
                            <div
                                key={idx}
                                className="bg-[#FFFFFF0D] border border-[#FFFFFF1A] rounded-[30px] pb-6 p-5 sm:p-6 flex flex-col items-start gap-3 justify-between transition-all duration-300 ease-out hover:scale-[1.02] hover:shadow-[0_0_20px_rgba(255,255,255,0.08)] hover:border-[#FFFFFF26] cursor-pointer"
                            >
                                <div
