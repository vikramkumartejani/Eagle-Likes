...
const Hero = () => {
    return (
        <section className="relative gpu w-full overflow-x-hidden overflow-y-visible flex flex-col items-center justify-start sm:justify-center pt-23.5 md:pt-48 pb-[26.72px] sm:pb-18.75 border-b-[1.5px] border-[#0663CD4D]">
            ...
            <div className='block md:hidden w-full h-199.25 absolute inset-0 top-0' style={{
                background: "linear-gradient(180deg, #0663cd32 19.23%, rgba(0, 0, 0, 0.195) 100%)"
            }}></div>
