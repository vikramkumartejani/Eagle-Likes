            ...
            <div className='max-w-269.5 mx-auto'>
                ...
                <div className='space-y-16.5 md:space-y-20 mt-11.5 md:mt-13.75'>
                    <div className='flex items-center justify-between gap-9 md:gap-6 flex-col-reverse md:flex-row'>
                        ...
                        <Image src='/assets/why-buy-instagram-followers.jpg' alt='image' width={380} height={540} className='rounded-[80px] sm:rounded-[120px] w-[240px] md:w-[380px] h-[330px] md:h-[540px] object-cover' style={{ boxShadow: "0px 7px 30px 0px #1489E999" }} priority decoding="async" sizes="(max-width: 1024px) 240px, 380px" />
                    </div>

                    <div className='flex items-center justify-between gap-9 md:gap-6 flex-col md:flex-row'>
                        <Image src='/assets/boost-organic-growth.jpg' alt='image' width={380} height={540} className='rounded-[80px] sm:rounded-[120px] w-[240px] md:w-[380px] object-cover h-[330px] md:h-[540px]' style={{ boxShadow: "0px 7px 30px 0px #1489E999" }} priority decoding="async" sizes="(max-width: 1024px) 240px, 380px" />
