...
const ToggleSwitch: React.FC<ToggleSwitchProps> = ({ checked, onChange }) => {
    return (
        <button
            ...
            className={`group sm:w-[50px] w-[45px] h-[26px] rounded-full relative shrink-0 transition-all duration-0 outline-none ease-in-out cursor-pointer overflow-hidden ${checked
