                ...
                <div className="space-y-[52px] md:space-y-20 mt-11.5 md:mt-13.75">
                    <div className="flex items-center justify-between gap-9 md:gap-6 flex-col-reverse md:flex-row">
                        <div className="max-w-102.5 text-center md:text-left">
                            <h2 className="mb-[25px] sm:mb-6 text-[30px] sm:text-[48px] leading-[30px] sm:leading-13.75 font-bold font-inter capitalize">
                                Secure Payments
                            </h2>
                            <p className="max-w-97.5 text-[#99A1AF] text-[15px] sm:text-[18px] leading-5 sm:leading-7 font-semibold font-inter">
                            ...
                            <p className="mt-2 max-w-99 text-[#99A1AF] text-[14px] sm:text-[16px] leading-5 sm:leading-6.5 font-normal font-inter">
                        ...
                        <Image
                            src="/assets/secure-payments.png"
                            alt="image"
                            width={380}
                            height={540}
                    ...
                    <div className="flex items-center justify-between gap-9 md:gap-6 flex-col md:flex-row">
                        ...
                        <div className="max-w-99.5 text-center md:text-left">
                            ...
                            <p className="max-w-97.5 text-[#99A1AF] text-[15px] sm:text-[18px] leading-5 sm:leading-7 font-semibold font-inter">
                                ...
                                purchased Instagram followers from Eagle Likes. We strictly
                                protect all client data, including your identity and account
                                details, with advanced encryption and security. We never share
                                customer information—ever.
                            </p>
                            <p className="mt-2 max-w-99 text-[#99A1AF] text-[14px] sm:text-[16px] leading-5 sm:leading-7 font-normal font-inter">
                                You can order privately no full name required and we offer
                                privacy-friendly payment options like Bitcoin and cards. We also
                                never ask for your Instagram password, so your account remains
                                fully secure.
                            </p>
                        </div>
                    </div>
                ...
                <div className="flex flex-col lg:flex-row items-center justify-between gap-[30px] md:gap-16 lg:gap-8 mt-[65px] md:mt-20 lg:mt-50.5">
                    ...
                    <div className="flex-1 max-w-125 mx-auto text-center lg:text-left">
                        ...
                        <div className="inline-flex items-center gap-3 px-4.25 py-2 rounded-full bg-[#AD46FF33] border border-[#AD46FF4D] mb-4">
                            ...
                            <span className="text-[#DAB2FF] text-[16px] leading-6 font-normal font-arial-custom">
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 sm:gap-4">
                            ...
                            <div className="bg-[#FFFFFF0D] border border-[#FFFFFF1A] rounded-[16px] sm:rounded-4xl p-4 sm:p-4.25 flex flex-col items-center text-center">
                                ...
                                <p className="text-[#99A1AF] text-[14px] sm:text-[16px] leading-5 sm:leading-6 font-normal font-arial-custom">
                                    Organic Growth
                                </p>
                            </div>
                            ...
                            <div className="bg-[#FFFFFF0D] border border-[#FFFFFF1A] rounded-[16px] sm:rounded-4xl p-4.25 flex flex-col items-center text-center">
                                ...
                                >
                                    <path
                                        d="M1.66669 7.91711C1.6667 6.98977 1.94801 6.08426 2.47346 5.32016C2.99891 4.55606 3.74378 3.96932 4.60969 3.63744C5.4756 3.30556 6.42182 3.24414 7.32336 3.46131C8.22491 3.67848 9.03937 4.16401 9.65919 4.85377C9.70284 4.90045 9.75562 4.93766 9.81425 4.96311C9.87288 4.98855 9.93611 5.00168 10 5.00168C10.0639 5.00168 10.1271 4.98855 10.1858 4.96311C10.2444 4.93766 10.2972 4.90045 10.3408 4.85377C10.9587 4.15952 11.7734 3.66991 12.6764 3.45011C13.5794 3.2303 14.5279 3.29073 15.3957 3.62334C16.2635 3.95596 17.0095 4.54498 17.5343 5.31202C18.059 6.07907 18.3378 6.98774 18.3333 7.91711C18.3333 9.82544 17.0833 11.2504 15.8333 12.5004L11.2567 16.9279C11.1014 17.1062 10.9099 17.2495 10.695 17.3482C10.4801 17.4468 10.2467 17.4986 10.0102 17.5001C9.7738 17.5016 9.53973 17.4528 9.32359 17.3568C9.10746 17.2609 8.91421 17.1201 8.75669 16.9437L4.16669 12.5004C2.91669 11.2504 1.66669 9.83377 1.66669 7.91711Z"
                                        fill="#FB64B6"
                                        stroke="#FB64B6"
                                        strokeWidth="1.66667"
                                        strokeLinecap="round"
                    ...
                    <div className="lg:w-115 h-full sm:rounded-[40px] overflow-hidden relative">
                        <Image
