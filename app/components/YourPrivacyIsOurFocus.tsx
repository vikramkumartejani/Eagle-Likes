    ...
    return (
        <div className='w-full pt-38.75 pb-40.25 px-5'>
            <div className='max-w-269.5 mx-auto'>
                ...
                <div className="flex flex-col lg:flex-row items-center justify-between gap-16 lg:gap-8 mt-50.5">
                    ...
                    <div className="flex-1 max-w-125">
                        ...
                        <h2 className="text-[48px] leading-15 font-inter font-bold text-white mb-5">
                            Get Thousands of <br />
                            <span
                        ...
                        <p className="text-[#99A1AF] text-[18px] leading-[27.9px] font-normal mb-4.5 font-inter">
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                            {/* Real Card */}
                            <div className="bg-[#FFFFFF0D] border border-[#FFFFFF1A] rounded-4xl p-4.25 flex flex-col items-center text-center">
                                <Image src='/assets/star-3.svg' alt='star' width={20} height={20} />
                                <h3 className="text-white text-[24px] leading-9 font-normal my-2 font-arial-custom">Real</h3>
                                <p className="text-[#99A1AF] text-[16px] leading-6 font-normal font-arial-custom">Organic Growth</p>
                            </div>
                            ...
                            <div className="bg-[#FFFFFF0D] border border-[#FFFFFF1A] rounded-4xl p-4.25 flex flex-col items-center text-center">
                                ...
                                <h3 className="text-white text-[24px] leading-9 font-normal my-2 font-arial-custom">Fast</h3>
                                <p className="text-[#99A1AF] text-[16px] leading-6 font-normal font-arial-custom">Instant Results</p>
                            </div>
                            ...
                            <div className="bg-[#FFFFFF0D] border border-[#FFFFFF1A] rounded-4xl p-4.25 flex flex-col items-center text-center">
                                ...
                                <h3 className="text-white text-[24px] leading-9 font-normal my-2 font-arial-custom">Safe</h3>
                                <p className="text-[#99A1AF] text-[16px] leading-6 font-normal font-arial-custom">100% Secure</p>
                            </div>
                        </div>
                    </div>
